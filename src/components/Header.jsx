  ...
  return (
    ...
    <div className='container text-center mx-auto py-4 px-6 md:px-20 lg:px-32 text-white'>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mt-6">
            <a href="#Projects" className="px-6 py-3 bg-blue-500 rounded-full text-white">Projects</a>
            <a href="#Contact" className="px-6 py-3 bg-green-500 rounded-full text-white">Contact Us</a>
        </div>
    </div>
